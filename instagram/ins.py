...
class InsSpider(object):
    def __init__(self,user_id):
        self.url_base = 'https://www.instagram.com/'
        self.uri = 'https://www.instagram.com/graphql/query/?query_hash=a5164aed103f24b03e7b7747a2d94e3c&variables=%7B%22id%22%3A%22{user_id}%22%2C%22first%22%3A12%2C%22after%22%3A%22{cursor}%22%7D'
        self.headers = {
            'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36',
            'cookie': '这里加上自己的cookie'
        }
        self.proxy = '这里加上自己的代理'
    ...
    def main(self,user):
        ...
        dirpath = os.path.dirname(os.path.abspath(__file__)) + '{0}'.format(user)
        ...
        for i in range(len(urls)):
            ...
            try:
                ...
                file_path = os.path.dirname(os.path.abspath(__file__)) + '{0}/{1}.{2}'.format(user, md5(content).hexdigest(), endw)
